...
try {
    ...
    $mail->Username = 'pensapu22@gmail.com'; //SMTP username
    $mail->Password = 'hxjvkowebmvjdhnc'; //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS; //Enable implicit TLS encryption
    $mail->Port = 465; //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('marvelclement11@gmail.com', 'Marvelled');
    $mail->addAddress('marvelclement11@gmail.com', 'Joe User'); //Add a recipient
    // $mail->addAddress('ellen@example.com'); //Name is optional
    $mail->addReplyTo('puonlinedocumentrequest@gmail.com', 'Information');
    ...
    $mail->Subject = 'TRANSCRIPT REQUEST';
    $mail->Body = 'Student ID: ';
